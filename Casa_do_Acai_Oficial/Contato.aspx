...
<body>
    <form id="form1" runat="server">
            ...
            <div class="row">
                <div class="col-12 col-md-4">
                    <div class="login-box">
                        <h1>Contato</h1>
                        <p>
                            Entre em contato conosco para tirar<br>
                            sua duvida ou dar sugestões.
                        </p>
                        <p>
                            Basta preencher os campos com<br>
                            as suas informações
                        </p>
                    </div>
                    <div class="card">
        ...
        <div class="principal" style="position: absolute; margin-top: 10px; width: 100%">
