    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 col-md-4">
                <div class="login-box">
                    <h1>Contato</h1>
                    <p>Entre em contato conosco para tirar<br> sua duvida ou dar sugestões.</p>
                    <p>Basta preencher os campos com<br> as suas informações</p>
                </div>
                <div class="card">
                    <div class="card-body login-box">
                        <div class="textBox">
                            <i class="fa fa-user-circle" aria-hidden="true"></i><input type="text" id="nome" name=""
                                value="" placeholder="Nome">
                        </div>
                        <div class="textBox">
                            <i class="fa fa-envelope" aria-hidden="true"></i><input type="text" id="email" name=""
