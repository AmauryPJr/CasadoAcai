<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Menu_Adm.aspx.cs" Inherits="Menu_Adm" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="text-body">
            <div class="text-center">
                <asp:Label ID="lblBemVindo" runat="server" Font-Names="CHICKEN Pie" Font-Size="18pt" />
            </div>
        </div>
